...
Route::get('san-pham/{alias}',['as'=>'getProductMax', 'uses'=>'IndexController@getProductMax']);
...
Route::get('xoa-gio-hang/{id}','IndexController@deleteCart')->name('xoa-gio-hang');
...
Route::get('dich-vu/{alias}',['as'=>'getNewsDetail', 'uses'=>'IndexController@getNewsDetail']);
