      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview ">
          ...
          <ul class="treeview-menu">
            <li><a href="backend/productcate"><i class="fa fa-circle-o"></i> <span>Danh mục cha</span></a></li>
            <li><a href="backend/product?san-pham"><i class="fa fa-circle-o"></i> <span>Sản phẩm</span></a></li>
        ...
        <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="backend/newscate?type=dich-vu"><i class="fa fa-circle-o"></i> <span>Danh sách</span></a></li>
                <li><a href="backend/news?type=dich-vu"><i class="fa fa-circle-o"></i><span>Các bài viết</span></a></li>
